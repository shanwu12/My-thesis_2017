...
\usepackage{titletoc}
%%设置目录里章节标题格式
\def\tocchapterfmt{\songti\xiaosizi\vspace{0.17cm}}
\def\tocsectionfmt{\songti\xiaosizi\vspace{0.17cm}}
\def\tocsubsectionfmt{\songti\xiaosizi\vspace{0.17cm}}
...
\titlecontents{subsection}[3.5em]{\tocsubsectionfmt} {\thecontentslabel\hspace{0.3em}}{} {\mydotfill\hspace{-0.5em}\contentspage}
